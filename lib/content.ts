...
export const copy = {
  en: {
    ...
    upcomingLabel: "In development", upcomingTitle: "More clarity is coming.", upcomingBadge: "Coming soon",
    upcoming: ["How it works — in detail", "Sample inspection report", "Defects our system identifies", "Why AeroSight comparison"],
  ...
  da: {
    ...
    upcomingLabel: "Under udvikling", upcomingTitle: "Mere indsigt er på vej.", upcomingBadge: "Kommer snart",
    upcoming: ["Sådan virker det — i detaljer", "Eksempel på inspektionsrapport", "Skader vores system identificerer", "Hvorfor AeroSight-sammenligning"],
