  ...
  return <main>
    <section className="grain relative min-h-[820px] overflow-hidden bg-[var(--ink)] text-white">
      ...
      <div className="shell relative z-10 flex min-h-[820px] flex-col justify-end pb-12 pt-36">
        ...
        <div className="mt-10 grid items-end gap-8 border-t border-white/25 pt-7 md:grid-cols-2"><p className="max-w-xl text-lg leading-7 text-white/80">{t.intro}</p><div className="flex flex-wrap gap-3 md:justify-end"><a href="#contact" className="rounded-full bg-[var(--signal)] px-6 py-4 text-sm font-semibold text-[var(--ink)]">{t.primary} ↗</a><a href="#solutions" className="rounded-full border border-white/50 px-6 py-4 text-sm">{t.secondary}</a></div></div>
      </div>
    </section>
